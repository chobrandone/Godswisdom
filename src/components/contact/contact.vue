              ...
              <div class="row">
                <form>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                      <label
                        class="control-label required sr-only"
                        for="select"
                      ></label>
    ...
    <div class="space-medium">
      <div class="container">
        ...
        <div class="row">
          ...
          <div
            class="col-lg-offset-1 col-lg-5 col-md-offset-1 col-md-5 col-sm-6 col-xs-12"
          >
            <div class="">
...
.contact-pageheader {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(145, 238, 226, 1) 0%,
    rgba(145, 238, 226, 1) 22%,
    rgba(145, 238, 226, 1) 31%,
    rgba(145, 238, 226, 1) 39%,
    rgba(57, 196, 182, 1) 71%,
    rgba(57, 196, 182, 1) 100%
  );
